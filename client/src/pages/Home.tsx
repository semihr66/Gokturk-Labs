...
const plans = [
  ...
  { name: "Dengeli", price: "₺50", note: "tek sefer", label: "DENGELİ · 4 MODÜL", detail: "Başlangıç kapsamını moderasyon, loglama ve 4 modüllük çalışma alanıyla büyütür.", performance: "Dengeli", score: 2, tone: "plain", icon: Code2, features: ["Başlangıç paketindeki tüm özellikler", "Moderasyon ve loglama", "Gelişmiş otomasyon sistemleri", "4 modül hakkı (Sınırlı)", "Modüllü seçenek: Kod paylaşılmaz, Göktürk Labs sunucusunda çalışır", "Custom bot seçeneği yok (Sadece modüllü)", "İsim, logo, kapak görseli düzenleme var", "Açıklama + banner'da zorunlu: \"Powered by Göktürk Labs\" + link (kaldırılamaz)"] },
  { name: "Gelişmiş", price: "₺150", note: "tek sefer", label: "GELİŞMİŞ · 8 MODÜL", detail: "Dengeli paketinin üzerine özel komutlar, daha geniş modül sınırı ve custom seçeneği eklenir.", performance: "Yüksek", score: 3, tone: "featured", icon: Sparkles, features: ["Dengeli paketindeki tüm özellikler", "Ticket ve özel komutlar", "Gelişmiş sunucu sistemleri", "8 modül hakkı (Sınırlı)", "Modüllü seçenek: Kod paylaşılmaz, Göktürk Labs sunucusunda çalışır", "Custom seçenek: Kod paylaşılır, sizin veya Göktürk Labs sunucusunda çalışır", "İsim, logo, kapak görseli düzenleme", "\"Powered by\" ibaresi sorunsuz kaldırılabilir"] },
  { name: "Pro", price: "₺350", note: "tek sefer", label: "PRO / ÖNCELİKLİ · 12 MODÜL", detail: "Gelişmiş kapsamına en geniş modül sınırı, web paneli ve öncelikli destek eklenir.", performance: "Öncelikli", score: 4, tone: "warm", icon: WandSparkles, features: ["Gelişmiş paketindeki tüm özellikler", "12 modül hakkı (Sınırlı)", "Modüllü seçenek: Kod paylaşılmaz, Göktürk Labs sunucusunda çalışır", "Custom seçenek: Kod paylaşılır, sizin veya Göktürk Labs sunucusunda çalışır", "İleri seviye özel sistemler", "Web panel desteği ve öncelikli teknik destek", "İsim, logo, kapak görseli düzenleme", "\"Powered by\" ibaresi sorunsuz kaldırılabilir"] },
];
