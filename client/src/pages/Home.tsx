...
import { ArrowRight, ArrowUpRight, Blocks, Check, ChevronDown, ClipboardCopy, Code2, Headphones, Image as ImageIcon, Layers3, LockKeyhole, MessageCircle, Palette, Play, Settings2, ShieldCheck, Sparkles, SlidersHorizontal, Terminal, WandSparkles, X, Zap } from "lucide-react";
...
const plans = [
  { name: "Başlangıç (Free)", price: "₺0", note: "başlangıç", label: "FREE PLAN", detail: "Temel komutlar ve hazır modüllerle sade bir bot başlangıcı.", performance: "Temel", score: 1, tone: "plain", icon: Terminal, features: ["Temel komutlar", "Temel otomasyon özellikleri", "Hazır modüllerle kurulum", "2 modül hakkı", "Kullanıcının kendi sunucusunda çalışma", "İsim/logo/kapak düzenleme yok", "Zorunlu: Sunucu adı/açıklamasında \"— By Göktürk Labs\" + link, ayrıca banner'da da \"Powered by Göktürk Labs\" + link (ikisi de kaldırılamaz)"] },
  { name: "Dengeli", price: "₺50", note: "tek sefer", label: "DENGELİ", detail: "Başlangıç kapsamını moderasyon, loglama ve daha geniş modül hakkıyla büyütür.", performance: "Dengeli", score: 2, tone: "plain", icon: Code2, features: ["Başlangıç paketindeki tüm özellikler", "Moderasyon ve loglama", "Gelişmiş otomasyon sistemleri", "4 modül hakkı", "Kullanıcının veya Göktürk Labs sunucusunun seçimi", "İsim, logo, kapak görseli düzenleme var", "Açıklama + banner'da zorunlu: \"Powered by Göktürk Labs\" + link (kaldırılamaz)"] },
  { name: "Gelişmiş", price: "₺180", note: "tek sefer", label: "EN ÇOK TERCİH EDİLEN", detail: "Dengeli paketinin üzerine özel komutlar, tüm modüller ve custom bot seçeneği eklenir.", performance: "Yüksek", score: 3, tone: "featured", icon: Sparkles, features: ["Dengeli paketindeki tüm özellikler", "Ticket ve özel komutlar", "Gelişmiş sunucu sistemleri", "Tüm modüller + custom bot seçeneği", "İsim, logo, kapak görseli düzenleme", "\"Powered by\" ibaresi sorunsuz kaldırılabilir"] },
  { name: "Pro", price: "₺350", note: "tek sefer", label: "PRO / ÖNCELİKLİ", detail: "Gelişmiş kapsamına ileri seviye özel sistemler, web paneli ve öncelikli destek eklenir.", performance: "Öncelikli", score: 4, tone: "warm", icon: WandSparkles, features: ["Gelişmiş paketindeki tüm özellikler", "Tüm modüller + custom bot seçeneği", "İleri seviye özel sistemler", "Web panel desteği ve öncelikli teknik destek", "İsim, logo, kapak görseli düzenleme", "\"Powered by\" ibaresi sorunsuz kaldırılabilir"] },
];
...
function FeatureIcon({ feature }: { feature: string }) {
  if (feature === "İsim/logo/kapak düzenleme yok") return <X className="mt-0.5 h-4 w-4 shrink-0 text-[#ffb547]" aria-hidden="true" />;
