    ...
    case 7: // 08 Yapay zeka & asistan
      return (
        <div className="relative z-10 flex flex-col justify-between h-full select-none">
          ...
          <div className="my-auto rounded bg-black/40 border border-white/5 p-1.5 text-[9px] text-white/90">
            <div className="flex items-center gap-1 text-[8px] text-purple-300 font-mono mb-0.5">
              <span className="h-1.5 w-1.5 rounded-full bg-emerald-400 animate-ping" />
              <span>Akıllı Model Hazırlanıyor...</span>
            </div>
            <span className="italic text-white/70">"Sunucuna özel Türkçe yapay zeka desteği"</span>
          </div>
          <div className="text-[8px] flex items-center justify-between text-[#8f8e9c]">
            <span>/sor komutu &amp; Sohbet</span>
            <span className="text-amber-400 font-semibold font-mono">v1.0 AI</span>
          </div>
        </div>
      );
