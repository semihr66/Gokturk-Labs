...
const extraSystems: Array<{
  ...
  { 
    title: "Ses & Müzik", 
    detail: "Özel ses odası oluşturucu (JTC), 128 kbps kristal netliğinde ses kalitesi ve /play müzik çalar sistemi.", 
    icon: Music, 
    cover: "cover-music", 
    badge: "PLAY READY" 
  },
      ...
      return (
        <div className="relative z-10 flex flex-col justify-between h-full select-none">
          <div className="flex items-center justify-between border-b border-white/[0.08] pb-1">
            ...
            <span className="rounded bg-pink-500/20 border border-pink-500/40 px-1.5 py-0.2 text-[8px] font-black text-pink-300">
              128 KBPS HD
            </span>
          </div>
          <div className="my-auto flex flex-col gap-1 rounded bg-black/40 border border-white/5 p-1.5 text-[8.5px]">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-1 text-white/90 font-medium truncate">
                <span className="text-pink-400">🎵</span>
                <span className="truncate font-semibold">/play Lofi Beats</span>
              </div>
              <span className="text-emerald-400 font-mono text-[8px] flex items-center gap-1">
            ...
            <div className="flex items-center gap-1.5 text-[8px] text-zinc-400 font-mono">
              <div className="flex gap-0.5 items-end h-2.5">
                <span className="w-0.5 bg-pink-400 h-2 animate-pulse" />
                <span className="w-0.5 bg-pink-300 h-2.5 animate-bounce" />
                <span className="w-0.5 bg-pink-400 h-1.5 animate-pulse" />
                <span className="w-0.5 bg-purple-400 h-2.5 animate-bounce" />
              </div>
              <span className="text-zinc-300">01:45 / 03:20</span>
              <span className="ml-auto text-pink-300 font-bold">🔊 %100</span>
            </div>
          </div>
          <div className="text-[8px] flex items-center justify-between text-[#8f8e9c]">
            <span className="text-pink-300 font-mono">🔊 Özel Oda + 🎵 Play</span>
            <span className="text-emerald-400 font-semibold font-mono">✓ Ultra HD</span>
          </div>
        </div>
      );
          ...
          <div className="lg:col-span-7 rounded-2xl border border-white/10 bg-[#0d0d12] p-6 flex flex-col justify-between shadow-2xl relative overflow-hidden">
            <div>
              ...
              <div className="mt-4 p-3.5 rounded-xl border border-white/[0.08] bg-[#14141c] flex items-center justify-between">
                  ...
                  <div>
                    <h4 className="text-sm font-bold text-white flex items-center gap-2">
                      ...
                      <span className="text-[10px] font-mono px-1.5 py-0.5 rounded bg-white/10 text-zinc-300">
                        {userLimit === 0 ? 'Sınırsız' : `${userLimit} Limit`}
                      </span>
                    </h4>
                ...
                <div className="flex items-center gap-2">
                  <span className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-emerald-500/15 border border-emerald-500/30 text-emerald-300 text-[10px] font-bold">
              ...
              <div className="mt-3 grid grid-cols-3 gap-2">
                ...
                <div className="p-2 rounded-lg bg-black/40 border border-white/5 flex items-center gap-2 text-xs">
                  <div className="relative">
                    <div className="h-6 w-6 rounded-full bg-purple-600 flex items-center justify-center text-white text-[10px] font-bold">
                      Y
                    </div>
                    <span className="absolute -bottom-0.5 -right-0.5 h-1.5 w-1.5 rounded-full bg-emerald-400" />
                  </div>
                  <div className="truncate">
                    <span className="font-semibold text-white block text-[11px] truncate">Yönetici</span>
                    <span className="text-[9px] text-zinc-400">Oda Sahibi</span>
                  </div>
                </div>

                <div className="p-2 rounded-lg bg-black/40 border border-white/5 flex items-center gap-2 text-xs">
                  <div className="relative">
                    <div className="h-6 w-6 rounded-full bg-cyan-600 flex items-center justify-center text-white text-[10px] font-bold">
                      Ü
                    </div>
                    <span className="absolute -bottom-0.5 -right-0.5 h-1.5 w-1.5 rounded-full bg-zinc-600" />
                  </div>
                  <div className="truncate">
                    <span className="font-semibold text-white block text-[11px] truncate">Dinleyici</span>
                    <span className="text-[9px] text-zinc-500">Sessizde</span>
                  </div>
                </div>
              </div>
...
export default function Home() {
  ...
  return <main className="new-site min-h-screen overflow-x-hidden bg-[#08080b] text-[#f7f7fb]"><ClickBurst /><header className="new-nav"><div className="new-nav-inner"><a href="#top" className="flex items-center gap-3" aria-label="Göktürk Labs ana sayfa"><img src={LOGO_URL} alt="Göktürk Labs logosu" className="h-8 w-8 object-contain" /><span className="font-display text-[15px] font-semibold tracking-[-0.02em]">Göktürk <span className="text-[#9333ea]">Labs</span></span></a><nav className="hidden items-center gap-7 text-[13px] text-[#aaa9b5] md:flex"><a href="#nasil">Nasıl çalışır?</a><a href="#moduller">Modüller</a><a href="#ses-muzik" className="hover:text-pink-300 transition-colors inline-flex items-center gap-1.5"><Music className="h-3.5 w-3.5 text-pink-400" /><span>Ses &amp; Müzik</span></a><a href="#paketler">Paketler</a><a href="#sss">SSS</a><a href={COMMUNITY_URL} target="_blank" rel="noreferrer" className="community-nav-cta"><DiscordMark className="h-4 w-4" /><span>Topluluk &amp; destek</span><ArrowUpRight className="h-4 w-4" /></a></nav></div></header>
    ...
    <section id="moduller" className="extra-systems-section"><div className="mx-auto max-w-7xl px-5"><div className="extra-systems-heading motion-reveal"><div><div className="section-kicker flex items-center gap-2"><BlocksIcon className="h-4 w-4" /> MODÜLLER</div><h2>Custom ve<br /><span>modüllü seçenekler.</span></h2></div><p>Gelişmiş paketinden sonra custom bot ile daha özel bir çalışma düzenine geçebilirsin. İhtiyacına göre modülleri, akışları ve sunucu araçlarını birlikte netleştiririz.</p></div><div className="extra-systems-grid">{extraSystems.map(({ title, detail, cover, badge, poweredBy }, index) => <article className={`extra-system-card motion-reveal ${cover}`} style={{ "--stagger": `${index * 45}ms` } as CSSProperties} key={title}><div className="extra-system-cover"><ModuleCover index={index} /></div><div className="extra-system-meta"><span><i /> 0{index + 1}</span>{badge ? <span className="rounded bg-gradient-to-r from-amber-500/20 to-purple-500/20 border border-amber-400/40 text-amber-300 px-1.5 py-0.2 text-[8px] font-black tracking-wider animate-pulse">{badge}</span> : <span>EK MODÜL</span>}</div><h3>{title}</h3><p>{detail}</p>{poweredBy && <div className="mt-3 pt-2 border-t border-white/[0.08] text-[11px] text-[#9a99a8] font-normal not-italic"><span>Powered by </span><a href={poweredBy.url} target="_blank" rel="noreferrer" className="font-bold text-amber-300 hover:text-amber-200 underline decoration-amber-400/50 underline-offset-2 transition-colors inline-flex items-center gap-0.5 not-italic">{poweredBy.label}<ArrowUpRight className="h-3 w-3 inline opacity-80" /></a></div>}</article>)}</div><div className="extra-systems-cta motion-reveal"><div><strong>İhtiyacın olan modül listede yok mu?</strong><span>Discord’da anlat, birlikte yeni bir modül akışı tasarlayalım.</span></div><DiscordButton label="Modül sor" plan="Modül talebi" outline /></div></div></section>
    <VoiceMusicStudio />
