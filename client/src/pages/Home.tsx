...
const plans = [
  { name: "Başlangıç (Free)", price: "₺0", note: "başlangıç", badge: "🎁 Ücretsiz Başlangıç", badgeType: "free", label: "FREE PLAN · KAMPANYA!", detail: "Temel komutlar ve hazır modüllerle sade bir bot başlangıcı.", performance: "Temel", score: 1, tone: "plain", icon: Terminal, notice: "Zorunlu: Sunucumuzda hakkımızda bir duyuru geçmeniz gerekmektedir (Örn: 'Göktürk Labs Discord botunu kullanıyorum, çok iyi, size de tavsiye ederim' tarzında destekleyici bir mesaj).", features: ["Temel komutlar", "Temel otomasyon özellikleri", "Hazır modüllerle kurulum", "3 + 1 modül hakkı · KAMPANYA!", "7/24 Kesintisiz VDS barındırma dahil", "Modüllü seçenek: Kod paylaşılmaz, Göktürk Labs sunucusunda çalışır", "İsim/logo/kapak düzenleme yok", "Zorunlu: Sunucu adı/açıklamasında \"— By Göktürk Labs\" + link, ayrıca banner'da da \"Powered by Göktürk Labs\" + link (ikisi de kaldırılamaz)"] },
