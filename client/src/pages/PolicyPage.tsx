...
const privacySections: PolicySection[] = [
  ...
  { title: "2. Ödeme Bilgileri", paragraphs: ["Ödemeler hizmete göre Shopier veya Google Play üzerinden gerçekleştirilebilir.", "Göktürk Labs, banka kartı veya kredi kartı bilgilerinin kendisine iletilmesini veya saklanmasını talep etmez."] },
